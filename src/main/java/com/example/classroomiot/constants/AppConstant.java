...
public interface AppConstant {
    ...
    interface message {
        ...
        interface zclassRoom {
            String SAVE_SUCCESS = "SAVE CLASS ROOM SUCCESSFULLY";
            String DELETE_SUCCESS = "DELETE CLASS ROOM SUCCESSFULLY";
            String UPDATE_SUCCESS = "UPDATE CLASS ROOM SUCCESSFULLY";
            String GET_SUCCESS = "GET CLASS ROOM SUCCESSFULLY";
            String GET_LIST_SUCCESS = "GET LIST CLASS ROOM SUCCESSFULLY";
        }

        interface time {
            String GET_START_AT_SUCCESS = "GET START AT SUCCESSFULLY";
            String GET_END_AT_SUCCESS = "GET END AT SUCCESSFULLY";
        }
